  ...
  if (site.covid === 1) {
    covid = (
      <CovidGuidelines>
        ...
        <span data-testid="descriptionTest">
          {firstName}
          {' '}
          has self-certified that Tenthop&apos;s COVID-19 Safety Standards have been implemented at this listing. See what’s being done here.
        </span>
      </CovidGuidelines>
    );
  }
