...
import {RecommendedContainer, RecommendText, GuestIcons, GuestAvatar} from './styles.js';
...
const Recommend = (props) => {
  ...
  for (var guest of props.recommendList) {
    recommendCount += guest.recommend;
  };

  var recommendPercentage = ((recommendCount / props.recommendList.length) * 100).toFixed(0);
  ...
  return (
    ...
    <RecommendedContainer>
      ...
      <RecommendText> {recommendPercentage}% Recommend  </RecommendText>
      <GuestIcons>
        <GuestAvatar>
          {props.recommendList.slice(0, 4).map((guest) => {
            return (
              <img style={avatarStyle} src={guest.guestAvatar}></img>
            )
          })}
        </GuestAvatar>
      </GuestIcons>
